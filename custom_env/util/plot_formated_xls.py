...
# Example usage
file_path = '/Users/hanwu/Downloads/Log_N65/Jianping_C/5_27_eex02_1/final_combined_output.xlsx'
column_name_list = ['Reward', 'DC_IQ', 'Load_Reg_loadReg', 'Line_Reg_100m_lineReg', 'Line_Reg_1m_lineReg',
                    ...
                    'Trans_Line_Reg_overShoot', 'Trans_Line_Reg_underShoot', 'PSR_psr_100']
