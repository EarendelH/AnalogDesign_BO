...
def main():
    init_params = load_yaml('/Users/hanwu/ML/AnalogDesignAuto_MultiAgent/custom_env/config/config_LFM/init_param.yaml')
    param_ranges = load_yaml('/Users/hanwu/ML/AnalogDesignAuto_MultiAgent/custom_env/config/config_LFM/param_range.yaml')
