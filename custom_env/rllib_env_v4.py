...
class RllibAnalogDesignAutoEnv(MultiAgentEnv):
    def __init__(self, generalize=True, path='', sim_output=False, init_method='file', action_mask=True,
        ...
        self.norm_specs_file = "config_4/norm_specs.yaml"
