...
class RllibAnalogDesignAutoEnv(MultiAgentEnv):
    def __init__(self, generalize=True,
        ...
        self.action_space = gen_masked_continuous_action_space(action_mask, self.device_mask_dict, agent_assign_dict)
    ...
    def step(self, action_dict):
        ...
        logging.info(f"Step!!!All action flatten: {all_action_flatten}")
