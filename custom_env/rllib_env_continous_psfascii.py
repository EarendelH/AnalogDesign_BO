...
class RllibAnalogDesignAutoEnv(MultiAgentEnv):
    def __init__(self, config: Dict[str, Any]):
        ...
        # Load config files
        config_folder_path = os.path.join(self.home_dir, "AnalogDesignAuto/AnalogDesignAuto_MultiAgent/custom_env",
                                          'config', self.config_folder_name)
        ...
        self.predefined_init_param = config_folder_path + "/init_param.yaml"
        self.device_mask_config = config_folder_path + "/device_mask.yaml"
        self.norm_specs_file = config_folder_path + "/norm_specs.yaml"
    ...
    def reset(self, *, seed=None, options=None):
        ...
        try:
            sim_result = copy.deepcopy(
                run_dynamic_simulation_psfascii(working_dir_reset, self.sim_config_dict, self.zero_sim_result,
...
def step_simulation_process(working_dir_step, region_extract_tag, valid_param, step_num, dc_check_tag, sim_config_dict,
    ...
    def _run_simulation_with_retry():
        return run_dynamic_simulation_psfascii(working_dir_step, sim_config_dict, zero_sim_result,
