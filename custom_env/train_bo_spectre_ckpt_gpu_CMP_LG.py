...
def get_default_config() -> Dict[str, Any]:
    ...
    return {
        "config_folder_name": "config_CMP_LG_single",
        "run_folder_name": "run_bo_CMP_LG_single",
        "netlist_folder_name": "netlist_template_CMP_LG",
        "specs_folder_name": "sampled_specs_CMP_LG",
        "device_mask_flag": True,
        "reward_func": "cal_reward_CMP_LG",
        "log_level": "INFO",
        "n_init": 32,
        "n_iter": 1000,
        "batch_size": 32,
