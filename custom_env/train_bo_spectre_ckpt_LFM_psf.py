...
from bo_spectre_environment_wrapper_psfascii import SpectreEnvironmentWrapper
...
def get_default_config() -> Dict[str, Any]:
    ...
    return {
        "config_folder_name": "config_AXS_Block_Simple",
        "run_folder_name": "run_AXS_BO",
        "netlist_folder_name": "netlist_template_AXS",
        "specs_folder_name": "sampled_specs_AXS_Simple",
