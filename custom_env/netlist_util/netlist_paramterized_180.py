...
def netlist_parameterized(input_scs_path, output_scs_path, output_yaml_path):
    ...
    formulas_summary = {
        ...
        "pch_5_mac_multi": {
            ...
            "sigma": "1",
            "sd": "540.0n",
            "ad": "((1-int(1/2)*2)*(4.8e-07+((1-1)*5.4e-07)/2+0)+(1+1-int((1+1)/2)*2)*((1/2)*5.4e-07))*w_{0}_per_finger",
            "as": "((1-int(1/2)*2)*(4.8e-07+((1-1)*5.4e-07)/2+0)+(1+1-int((1+1)/2)*2)*(4.8e-07+4.8e-07+(1/2-1)*5.4e-07+0+0))*w_{0}_per_finger",
            "pd": "(1-int(1/2)*2)*((4.8e-07+((1-1)*5.4e-07)/2+0)*2+(1+1)*w_{0}_per_finger)+(1+1-int((1+1)/2)*2)*(((1/2)*5.4e-07)*2+1*w_{0}_per_finger)",
            "ps": "(1-int(1/2)*2)*((4.8e-07+((1-1)*5.4e-07)/2+0)*2+(1+1)*w_{0}_per_finger)+(1+1-int((1+1)/2)*2)*((4.8e-07+4.8e-07+(1/2-1)*5.4e-07+0+0)*2+(1+2)*w_{0}_per_finger)",
            "nrd": "(1-int(1/2)*2)*(2.7e-07*2.7e-07/(2.7e-07+2.7e-07*(1-1))/w_{0}_per_finger)+(1+1-int((1+1)/2)*2)*(2.7e-07/1/w_{0}_per_finger)",
            "nrs": "(1-int(1/2)*2)*(2.7e-07*2.7e-07/(2.7e-07+2.7e-07*(1-1))/w_{0}_per_finger)+(1+1-int((1+1)/2)*2)*(2.7e-07*2.7e-07*2.7e-07/(2.7e-07*2.7e-07*(1-2)+2.7e-07*(2.7e-07+2.7e-07))/w_{0}_per_finger)",
            "sa": "1/(1 / ((4.8e-07 + l_{0}/2) + (5.4e-07 + l_{0})*(1-1)/3.5 ) )-(0.5*l_{0})",
            "sb": "1/(1 / ((4.8e-07 + l_{0}/2) + (5.4e-07 + l_{0})*(1-1)/3.5 ) )-(0.5*l_{0})",
            "sca": "0",
            "scb": "0",
