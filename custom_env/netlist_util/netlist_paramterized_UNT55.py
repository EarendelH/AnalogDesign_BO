...
def netlist_parameterized(input_scs_path, output_scs_path, output_yaml_path):
    ...
    formulas_summary = {
        "nld9_lcgd_sw_mac": {
            ...
            "nf": "nf_{0}",
            "mr": "17",
            "as": "3e-07*(0.0+(w_{0})/(nf_{0}))*1*(nf_{0})/2",
            "ad": "(4.86e-06+1.6e-06*(int((nf_{0})/2)-1))*(3e-06+(w_{0})/(nf_{0}))",
            "ps": "(3e-07+(0.0+(w_{0})/(nf_{0})))*1*(nf_{0})",
            "pd": "(4.86e-06+1.6e-06*(int((nf_{0})/2)-1))*2+(3e-06+(w_{0})/(nf_{0}))*((nf_{0})+2)",
            "mosdio_on": "1"
        },
        "nld8_lrsp_iso_mac": {
            "l": "100n",
            ...
            "mr": "17",
            "as": "3e-07*(0.0+(w_{0})/(nf_{0}))*1*(nf_{0})/2",
            "ad": "(4.6e-06+1.34e-06*(int((nf_{0})/2)-1))*(3e-06+(w_{0})/(nf_{0}))",
            "ps": "(3e-07+(0.0+(w_{0})/(nf_{0})))*1*(nf_{0})",
            "pd": "(4.6e-06+1.34e-06*(int((nf_{0})/2)-1))*2+(3e-06+(w_{0})/(nf_{0}))*((nf_{0})+2)",
            "mosdio_on": "1",
            "option_trr": "0"
        }
    }
