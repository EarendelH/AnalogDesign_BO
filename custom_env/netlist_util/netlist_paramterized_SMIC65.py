...
def netlist_parameterized(input_scs_path, output_scs_path, output_yaml_path):
    ...
    formulas_summary = {
        "nlvt12ll_power": {
            "w": "(w_{0}_per_finger) * (20)",
            "l": "l_{0}",
            "nf": "20",
            "as": "(((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) + (int(((20) - 1) / 2.0) * ((90n + 100n) * (w_{0}_per_finger))) + ((((20) / 2) - int((20) / 2) == 0) ? ((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) : 0)) / 1",
            "ad": "((int((20) / 2.0) * ((90n + 100n) * (w_{0}_per_finger))) + ((((20) / 2) - int((20) / 2) != 0) ? ((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) : 0)) / 1",
            "ps": "(((2 * (115n > (90n + 65n) ? 115n : (90n + 65n))) + (2 * (w_{0}_per_finger))) + (int(((20) - 1) / 2.0) * ((2 * (90n + 100n)) + (2 * (w_{0}_per_finger)))) + ((((20) / 2) - int((20) / 2) == 0) ? ((2 * (115n > (90n + 65n) ? 115n : (90n + 65n))) + (2 * (w_{0}_per_finger))) : 0)) / 1",
            "pd": "((int((20) / 2.0) * ((2 * (90n + 100n)) + (2 * (w_{0}_per_finger)))) + ((((20) / 2) - int((20) / 2) != 0) ? ((2 * (115n > (90n + 65n) ? 115n : (90n + 65n))) + (2 * (w_{0}_per_finger))) : 0)) / 1",
            "nrs": "(((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) + (int(((20) - 1) / 2.0) * ((90n + 100n) * (w_{0}_per_finger))) + ((((20) / 2) - int((20) / 2) == 0) ? ((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) : 0)) / 1 / ((w_{0}_per_finger) * (20) * (w_{0}_per_finger) * (20))",
            "nrd": "((int((20) / 2.0) * ((90n + 100n) * (w_{0}_per_finger))) + ((((20) / 2) - int((20) / 2) != 0) ? ((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) : 0)) / 1 / ((w_{0}_per_finger) * (20) * (w_{0}_per_finger) * (20))",
            "sa": "(115n > (90n + 65n) ? 115n : (90n + 65n))",
            "sb": "(115n > (90n + 65n) ? 115n : (90n + 65n))",
            "sd": "(90n + 100n)",
            "sca": "0",
            "scb": "0",
            "scc": "0",
        ...
        "nlvt12ll": {
            ...
            "l": "l_{0}",
            "nf": "nf_{0}",
            "as": "(((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) + (int(((nf_{0}) - 1) / 2.0) * ((90n + 100n) * (w_{0}_per_finger))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) == 0) ? ((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) : 0)) / 1",
            "ad": "((int((nf_{0}) / 2.0) * ((90n + 100n) * (w_{0}_per_finger))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) != 0) ? ((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) : 0)) / 1",
            "ps": "(((2 * (115n > (90n + 65n) ? 115n : (90n + 65n))) + (2 * (w_{0}_per_finger))) + (int(((nf_{0}) - 1) / 2.0) * ((2 * (90n + 100n)) + (2 * (w_{0}_per_finger)))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) == 0) ? ((2 * (115n > (90n + 65n) ? 115n : (90n + 65n))) + (2 * (w_{0}_per_finger))) : 0)) / 1",
            "pd": "((int((nf_{0}) / 2.0) * ((2 * (90n + 100n)) + (2 * (w_{0}_per_finger)))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) != 0) ? ((2 * (115n > (90n + 65n) ? 115n : (90n + 65n))) + (2 * (w_{0}_per_finger))) : 0)) / 1",
            "nrs": "(((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) + (int(((nf_{0}) - 1) / 2.0) * ((90n + 100n) * (w_{0}_per_finger))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) == 0) ? ((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) : 0)) / 1 / ((w_{0}_per_finger) * (nf_{0}) * (w_{0}_per_finger) * (nf_{0}))",
            "nrd": "((int((nf_{0}) / 2.0) * ((90n + 100n) * (w_{0}_per_finger))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) != 0) ? ((115n > (90n + 65n) ? 115n : (90n + 65n)) * (w_{0}_per_finger)) : 0)) / 1 / ((w_{0}_per_finger) * (nf_{0}) * (w_{0}_per_finger) * (nf_{0}))",
            "sa": "(115n > (90n + 65n) ? 115n : (90n + 65n))",
            "sb": "(115n > (90n + 65n) ? 115n : (90n + 65n))",
            "sd": "(90n + 100n)",
            "sca": "0",
        ...
        "p25ll": {
            ...
            "l": "l_{0}",
            "nf": "nf_{0}",
            "as": "(((115n > (90n + 105n) ? 115n : (90n + 105n)) * (w_{0}_per_finger)) + (int(((nf_{0}) - 1) / 2.0) * ((90n + 180n) * (w_{0}_per_finger))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) == 0) ? ((115n > (90n + 105n) ? 115n : (90n + 105n)) * (w_{0}_per_finger)) : 0)) / 1",
            "ad": "((int((nf_{0}) / 2.0) * ((90n + 180n) * (w_{0}_per_finger))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) != 0) ? ((115n > (90n + 105n) ? 115n : (90n + 105n)) * (w_{0}_per_finger)) : 0)) / 1",
            "ps": "(((2 * (115n > (90n + 105n) ? 115n : (90n + 105n))) + (2 * (w_{0}_per_finger))) + (int(((nf_{0}) - 1) / 2.0) * ((2 * (90n + 180n)) + (2 * (w_{0}_per_finger)))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) == 0) ? ((2 * (115n > (90n + 105n) ? 115n : (90n + 105n))) + (2 * (w_{0}_per_finger))) : 0)) / 1",
            "pd": "((int((nf_{0}) / 2.0) * ((2 * (90n + 180n)) + (2 * (w_{0}_per_finger)))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) != 0) ? ((2 * (115n > (90n + 105n) ? 115n : (90n + 105n))) + (2 * (w_{0}_per_finger))) : 0)) / 1",
            "nrs": "(((115n > (90n + 105n) ? 115n : (90n + 105n)) * (w_{0}_per_finger)) + (int(((nf_{0}) - 1) / 2.0) * ((90n + 180n) * (w_{0}_per_finger))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) == 0) ? ((115n > (90n + 105n) ? 115n : (90n + 105n)) * (w_{0}_per_finger)) : 0)) / 1 / ((w_{0}_per_finger) * (nf_{0}) * (w_{0}_per_finger) * (nf_{0}))",
            "nrd": "((int((nf_{0}) / 2.0) * ((90n + 180n) * (w_{0}_per_finger))) + ((((nf_{0}) / 2) - int((nf_{0}) / 2) != 0) ? ((115n > (90n + 105n) ? 115n : (90n + 105n)) * (w_{0}_per_finger)) : 0)) / 1 / ((w_{0}_per_finger) * (nf_{0}) * (w_{0}_per_finger) * (nf_{0}))",
            "sa": "(115n > (90n + 105n) ? 115n : (90n + 105n))",
            "sb": "(115n > (90n + 105n) ? 115n : (90n + 105n))",
            "sd": "(90n + 180n)",
            "sca": "0",
            "scb": "0",
            "scc": "0",
...
if __name__ == "__main__":
    input_scs_folder = "/Users/hanwu/ML/AnalogDesignAuto_MultiAgent/custom_env/netlist_original/netlist_original_Haoqiang_SMIC55"
    output_scs_folder = "/Users/hanwu/ML/AnalogDesignAuto_MultiAgent/custom_env/netlist_template/netlist_template_Haoqiang_SMIC55"
